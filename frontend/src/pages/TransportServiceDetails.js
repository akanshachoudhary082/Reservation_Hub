...
//   return (
//     <div style={{ backgroundColor: 'white', color: 'black', minHeight: '100vh', padding: '20px',borderRadius: 8, marginTop:'20px',width:'100%',marginTop:'20px', marginBottom:'20px' }}>
//       <Typography variant="h5" gutterBottom>Source to Destination</Typography>

//       <Paper sx={{ padding: 3, borderRadius: 2, backgroundColor: '#f9f9f9', boxShadow: 2, maxWidth: 1000, margin: '0 auto',marginTop:'80px' }}>
...
import Cookies from 'js-cookie'; 
import {
  Typography, Button, TextField, Grid, Paper, IconButton, Box, InputAdornment
} from '@mui/material';
import { SwapVert, Search, LocationOn, Flag } from '@mui/icons-material';
...
const TransportServiceDetails = () => {
  ...
  return (
    <div style={{
      backgroundColor: 'white', color: 'black', minHeight: '100vh', padding: '20px',
      borderRadius: 8, marginTop: '20px', width: '100%', marginBottom: '20px'
    }}>
      <Typography variant="h5" gutterBottom>Source to Destination</Typography>

      <Paper sx={{
        padding: 3, borderRadius: 2, backgroundColor: '#f9f9f9', boxShadow: 2,
        maxWidth: 1000, margin: '0 auto', marginTop: '80px'
      }}>
        <Box display="flex" flexDirection="column" alignItems="center" gap={1}>
          <TextField
            label="From"
        ...
        <Box mt={3}>
          ...
          <Grid container spacing={1} alignItems="center">
            ...
            <Grid item xs={6} sm={3}>
              <Button fullWidth variant="outlined" onClick={handleToday}
                sx={{
                  borderRadius: 2, fontWeight: 'bold', color: '#1976d2',
                  borderColor: '#1976d2', '&:hover': {
                    backgroundColor: '#e3f2fd', borderColor: '#115293'
                  }
                }}>
                Today
              </Button>
        ...
        <Box mt={3}>
          <Button
            ...
            sx={{
              ...
              borderRadius: 2, '&:hover': { backgroundColor: '#1565c0' }
            }}
          >
            Search
          </Button>
      ...
      <Box mt={4}>
        ...
        <Grid container spacing={3} sx={{ mt: 2 }}>
          {availableServices.map((service) => (
            <Grid item xs={12} sm={6} md={4} lg={3} key={service.id} sx={{ display: 'flex' }}>
              <Paper sx={{
                padding: 3,
                borderRadius: 3,
                ...
                <Button
                  ...
                  onClick={() => navigate(`/seats/${transport}?detailId=${service.detailId}`)}
                >
                  Book Now
                </Button>
              </Paper>
