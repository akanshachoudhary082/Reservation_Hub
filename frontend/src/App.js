    ...
    <Router>
      <div>
        ...
        <Routes>
          ...
          <Route path="/movies/:city" element={<Movies />} />
          ...
          <Route path="/movies/:city/:description" element={<MovieShowtimes />} />
          <Route path="/movies/:city/:description/:theaterName/:time" element={<MovieSeatSelection />} />
          <Route path="/events/:city/:description/:theaterName/:time" element={<EventSeatSelection />} />
